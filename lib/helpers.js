...
module.exports.CreateGiftCardRequest = (partnerId, sequentialId, amount, currencyCode) => {
  const params = {
  ...
  if (process.env.AGCOD_PROGRAMID) {
    params.programId = process.env.AGCOD_PROGRAMID
  }
